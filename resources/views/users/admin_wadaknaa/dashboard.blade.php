...
<div class="row">
  ...
  <hr>
  <form action="/searchbylocationadmin" method="POST">
  @csrf
  ...
  <hr>
  <form action="/searchbytypeadmin" method="POST">
  @csrf
  <div class="form-group">
    ...
    <button type="submit" class="btn btn-primary">Search by vehicle type</button>
  </form>
