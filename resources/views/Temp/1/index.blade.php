...
<body class="loading">
    <div class="wrapper">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-3 col-xs-12">
                        <div class="logo">
                            <a href="#"><img src="{{ URL::asset('assets/img/site-logo.png')}}" alt=""></a>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="text">
                            ...
                            <h6>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamc </h6>
                            <a class="button" href="#">Buy now</a>
                            <a class="button white" href="#">Try for free</a>
                        </div>
                    </div>
                    <div class="col-md-6">
        ...
        <section class="project">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <p class="button"><a class="button" href="#">Get started</a></p>
                    </div>
                </div>
            </div>
        </section>
                            ...
                            <div class="row">
                                <div class="col-md-3 col-sm-6 user_part_part">
                                    <div class="user_text">
                                        ...
                                        <h4>12000+ <br> Business</h4>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 user_part_part">
                                    <div class="user_text">
                                        <i class="material-icons">file_download</i>
                                        <h4>60000+ <br> Downloads</h4>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 user_part_part">
                                    <div class="user_text">
                                        <i class="material-icons">person</i>
                                        <h4>30000+ <br>Installs</h4>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 user_part_part">
                                    <div class="user_text">
                                        <i class="material-icons">file_download</i>
                                        <h4>40000+ <br> Pro Users</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="accordion">
                                ...
                                <div class="slide_up">
                                    <div class="accordion_img">
                                        <img src="{{ URL::asset('assets/img/accordion1.jpg')}}" alt="">
                                    </div>
        ...
        <section class="team">
            <div class="text">
                <h2>Our Team</h2>
                <p>Second year group project is a compulsory course unit for the students of University of Colombo School of Computing. This is the Project of team 16</p>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
